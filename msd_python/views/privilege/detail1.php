...
<div class="main_content">
    ...
    <div style="display:none;"><span class="label_c">封面图片:</span><span class="input"><input type="file"  accept = "image/*" name="img" /></span></div>
    <div style="display:none;"><span class="label_c">正文:</span><span class="input"><textarea class="textarea" name="content1"><?=$activity->content;?></textarea></span></div>
